...
module.exports = function(grunt) {
  ...
  // Project configuration.
    grunt.initConfig({
        ...
        simplemocha: {
            options: {
                globals: ['should', 'it', 'define','require','describe','Javelin', 'Plan10', 'THREE', 'window', 'self', 'before','after','beforeEach','afterEach'],
                timeout: 3000,
                ignoreLeaks: false,
                ui: 'bdd',
                reporter: 'tap'
        ...
        uglify: {
            ...
            my_target: {
                files: {
                    'build/plan10.min.js': ['build/plan10.js']
                }
            }
        }
    });
